                ...
                <div class="modal fade" id="modalSalir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" >
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="vuelos_internacionalreg_realizados.php"><button type="button" class="btn btn-primary" data-bs-dismiss="modal" >No</button></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-1">
              <div class="text-center">
                  <a class="btn btn-primary" href="listar_vuelo_internacionalregreso.php" role="button"><i class="bi bi-box-arrow-left"></i> Volver</a>
              </div>
            </div>
          </div>
          <br>
