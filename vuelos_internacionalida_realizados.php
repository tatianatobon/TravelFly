                ...
                <div class="modal fade" id="modalSalir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" >
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="vuelos_internacionalida_realizados.php"><button type="button" class="btn btn-primary" data-bs-dismiss="modal" >No</button></a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-1">
              <div class="text-center">
                  <a class="btn btn-primary" href="listar_vuelo_internacionalida.php" role="button"><i class="bi bi-box-arrow-left"></i> Volver</a>
              </div>
            </div>
          </div>
          <br>
          <div class="table-responsive">
            <table id="tablaAdmi" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
               ...
               INNER JOIN tiempo_vuelo ON vuelo.id_cant_horas = tiempo_vuelo.id_cant_horas WHERE tipo_vuelo.id_tipo_vuelo = '2' AND vuelo.estado = 'Realizado' ORDER BY id_vuelo;";
               $resultado = mysqli_query($enlace, $consulta);
