                                        ...
                                        <div class="modal-body">
                                            <div class="modal-content">
                                                <form action="" method="post" id="formulario">
                                                    ...
                                                    <strong><h5><center>|</center></h5></strong>
                                                    <strong><h5><center>|</center></h5></strong>
                                                    <strong><h5><center><i class="bi bi-chevron-double-down"></i></h5></strong>
                                        ...
                                        <div class="modal-body">
                                            <div class="modal-content">
                                                <form action="eliminar_tarjeta.php" method="post" id="formulario">
                                                    ...
                                                    <center>
                                                    <a href="vuelos_internacionalesida_user.php"><button type="button" class="btn btn-danger" data-bs-dismiss="modal" >Volver</button></a>
