                ...
                <div class="modal fade" id="modalSalir" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" >
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="listar_vuelo_internacionalida.php"><button type="button" class="btn btn-primary" data-bs-dismiss="modal" >No</button></a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table id="tablaAdmi" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                <?php
                $consulta = "SELECT vuelo.id_vuelo, vuelo.codVuelo, aerolineas.nombre_aerolinea, origen.ciudad_origen, vuelo.fecha_hora_salida, destino.ciudad_destino, 
                ...
                while($fila = mysqli_fetch_array($resultado)){?>  
                  ...
                  <!-- Modal crear Vuelo -->
                  <?php include('modales_vuelos_internacionalesida.php'); ?>
                <?php  } 
                  mysqli_close($enlace);
                ?>
              </tbody>
