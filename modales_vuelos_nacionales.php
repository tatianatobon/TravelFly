            ...
            <div class="modal-body">
                <div class="modal-content">
                    <form action="editar_vuelo_nacional.php" method="post" id="formulario" enctype="multipart/form-data">
                        ...
                        <label>Fecha y Hora de Salida</label>
                        <input type="datetime-local" class="form-control" style="width:70%; color: #515A5A;" name="fecha_hora_salida" value="<?php echo $fila['fecha_hora_salida']?>" class="form-control" placeholder=" " min ="2022-05-01" required>
