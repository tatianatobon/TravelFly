...
<html>
  <head>
    ...
    <!-- hoja de estilos 1 -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/estilos1.css')); ?>" />
    <!-- registrar bootstrap -->
  ...
  <footer>
    ...
    <!-- craer cuenta js -->
    <script defer src="<?php echo e(asset('js/crearCuenta.js')); ?>"></script>
    <!-- tools js -->
    ...
    <!-- scripts inicio js -->
    <script defer src="<?php echo e(asset('js/inicio.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\TravelFly\resources\views/layouts/navegador.blade.php ENDPATH**/ ?>